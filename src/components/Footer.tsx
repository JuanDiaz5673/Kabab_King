      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3 mt-5">
              {[
                ...
                { label: 'Google', icon: 'M12.545 10.239v3.821h5.445c-.712 2.315-2.647 3.972-5.445 3.972a6.033 6.033 0 110-12.064c1.498 0 2.866.549 3.921 1.453l2.814-2.814A10.016 10.016 0 0012.545 2C7.021 2 2.543 6.477 2.543 12s4.478 10 10.002 10c8.396 0 10.249-7.85 9.426-11.748l-9.426-.013z' },
              ].map((social) => (
                <a
                  key={social.label}
                  href="#"
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-white/30">
            Website by{' '}
            <a href="https://juandiaz.nyc" target="_blank" rel="noopener noreferrer" className="text-gold/50 hover:text-gold transition-colors">
              Juan Diaz
            </a>
          </p>
        </div>
