      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <h3 className="font-display text-xl font-bold text-white tracking-wide">Kabab King</h3>
                <p className="text-[10px] tracking-[0.2em] uppercase text-gold/70">Est. 1997</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="mt-4 p-3 bg-white/5 rounded-lg">
              ...
              <p className="text-sm text-white/70">All our meat is certified halal</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-white/60">
              <a href="tel:7184575857" className="flex items-start gap-2 hover:text-gold transition-colors">
              ...
              >
                ...
                7301 37th Rd<br />Jackson Heights, Queens, NY 11372
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/60">
            &copy; 2026 Kabab King. All rights reserved.
          </p>
          <p className="text-xs text-white/50">
            Website by{' '}
            <a href="https://juandiaz.nyc" target="_blank" rel="noopener noreferrer" className="text-gold/70 hover:text-gold transition-colors">
              Juan Diaz
            </a>
          </p>
        </div>
